...
const valueProps = [
  {
    ...
    copy: 'Air-gapped inference, no third-party telemetry, and audit logs worthy of litigation defence.',
  },
  {
    icon: Brain,
    title: 'Unfettered cognition',
    copy: 'Dark Deck operates uncapped under your doctrine, whether that is legal analysis or red-team scenarios.',
  },
  {
    icon: Cpu,
    title: 'Hardware engineered for speed',
    copy: 'Racks, GPUs, and orchestration pipelines tuned so conversations stay sub-50ms regardless of load.',
  },
];
...
export default function DarkDeckRequestPage() {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        <section className="mb-14 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/15 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-blue-200">
            Dark Deck engagement desk
          </div>
          <div className="mt-6 flex flex-col items-center gap-5">
            <Image src="/images/DarkDecklogo.png" alt="Dark Deck Logo" width={220} height={72} className="h-16 w-auto" priority />
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold leading-tight">
              Your sovereign AI, engineered under your roof
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-white/75 max-w-3xl">
              Dark Deck is the private conversational layer for principals, litigators, and intelligence teams that need absolute control over their data and decision flow.
            </p>
          </div>
        </section>
        ...
        <div className="mb-12 rounded-2xl border border-white/10 bg-white/5 p-6 md:p-8">
          <h2 className="text-center text-xl font-semibold text-blue-200">Proof from current installations</h2>
          ...
          <p className="mt-6 text-center text-sm text-white/60">
            Installed across litigation think tanks, red-team labs, and private equity research pods relying on Dark Deck for uncensored scenario planning.
          </p>
        </div>

        <div className="mb-12 rounded-2xl border-2 border-blue-500/30 bg-gradient-to-br from-blue-500/10 via-slate-950 to-slate-950 p-8">
          <div className="flex items-center gap-3">
            <Sparkles className="h-5 w-5 text-blue-200" />
            <h2 className="text-2xl font-semibold">Request your Dark Deck architecture brief</h2>
          </div>
          <p className="mt-3 text-sm text-white/65">
            Submit the form to schedule a private scoping call. The agenda and security questionnaire arrive immediately after submission.
          </p>
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label className="mb-2 block text-xs font-semibold uppercase tracking-[0.2em] text-white/55">Name *</label>
                <input
                  type="text"
                  required
                  value={formData.name}
            ...
            <div>
              <label className="mb-2 block text-xs font-semibold uppercase tracking-[0.2em] text-white/55">Company / Organization</label>
              <input
                type="text"
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label className="mb-2 block text-xs font-semibold uppercase tracking-[0.2em] text-white/55">Budget window *</label>
                <select
                  required
              ...
              <div>
                <label className="mb-2 block text-xs font-semibold uppercase tracking-[0.2em] text-white/55">Desired go-live *</label>
                <select
                  required
            ...
            <div>
              <label className="mb-2 block text-xs font-semibold uppercase tracking-[0.2em] text-white/55">Use case / what Dark Deck must deliver *</label>
              <textarea
                rows={4}
                required
                ...
                className="w-full rounded-xl border border-white/12 bg-slate-950/60 px-4 py-3 text-sm text-white focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                placeholder="Describe scenarios, corpora, or guardrails you need."
              />
            </div>
            ...
            <label className="inline-flex items-center gap-2 text-sm text-white/65">
              ...
              />
              Request Dark Deck beta passcode (limited slots)
            </label>
        ...
        <div className="mb-12 grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <CircuitBoard className="mb-3 h-8 w-8 text-blue-200" />
            <h3 className="mb-2 font-semibold text-white">Private LLM deployments</h3>
            <p className="text-sm text-white/65">Architecture, racks, GPUs, orchestration, and fine-tuning in your facility.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <Lock className="mb-3 h-8 w-8 text-blue-200" />
            <h3 className="mb-2 font-semibold text-white">Safety & jailbreak audits</h3>
            <p className="text-sm text-white/65">Prompt-injection, red-team, and legal review hardening for high-risk teams.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <Timer className="mb-3 h-8 w-8 text-blue-200" />
            <h3 className="mb-2 font-semibold text-white">Concierge architect support</h3>
            <p className="text-sm text-white/65">On-call strategy, retraining, and incident response guidance.</p>
          </div>
        </div>

        <div className="mb-10 rounded-2xl border border-blue-500/25 bg-blue-500/10 p-8 text-center">
          <h3 className="text-xl font-semibold text-blue-200">Engagement investment</h3>
          <p className="mt-3 text-sm text-white/70">Dark Deck builds start at $90k and scale with GPU footprint, corpora size, and concierge commitments.</p>
        </div>
        ...
        <div className="text-center">
          <h3 className="mb-4 font-semibold text-white">Ehab Allababidi — Private AI Systems Architect</h3>
          <div className="mb-4 flex flex-wrap items-center justify-center gap-4 text-white/60">
