    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white flex items-center justify-center p-4">
        <div className="max-w-2xl w-full text-center">
          <div className="rounded-2xl border-2 border-blue-500 bg-blue-500/10 p-12">
            <CheckCircle2 className="h-20 w-20 text-blue-500 mx-auto mb-6" />
            ...
            <Link href="/">
              <button className="px-6 py-3 bg-blue-500 text-black rounded-xl hover:bg-blue-500 transition font-medium">
                Return to Homepage
              </button>
            </Link>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Start Your <span className="text-blue-500">Digital Estate</span>
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-slate-950 border border-white/20 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition text-white"
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl bg-slate-950 border border-white/20 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition text-white resize-none"
          ...
          <div className="text-center">
            <button
              ...
              className="inline-flex items-center justify-center px-8 py-4 bg-blue-500 text-black rounded-2xl hover:bg-blue-500 transition font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-blue-500/20"
            >
              {status === 'loading' ? (
                <>
