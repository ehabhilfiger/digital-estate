  ...
  const siteStructure: SiteNode[] = [
    {
      ...
      children: [
        ...
        },
        {
          ...
          path: '/#work',
          icon: Users,
          description: 'Foundation, Estate, Architect packages',
          priority: 'high',
          children: [
            {
              id: 'foundation',
              title: 'Tier 1: Foundation',
              path: '/tiers/foundation',
              icon: Terminal,
              description: '$3.5k-$6k. Single-node NAS setup.',
              priority: 'medium',
            },
            {
              id: 'estate',
              ...
              path: '/tiers/estate',
              icon: Terminal,
              description: '$8k-$15k. Multi-server deployment.',
              priority: 'medium',
            },
            {
              id: 'architect',
              title: 'Tier 3: Architect',
              path: '/tiers/architect',
              icon: Terminal,
              description: '$20k+. Enterprise-grade infrastructure.',
              priority: 'medium',
            },
          ],
        },
