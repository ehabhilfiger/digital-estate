...
export default function DarkGPTPage() {
  return (
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Ehab Allababidi — <span className="text-amber-500">Private AI Systems Architect</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-white/60">
            <a href="mailto:defcon5ready@gmail.com" className="hover:text-amber-500 transition">
              defcon5ready@gmail.com
            </a>
            <span>•</span>
            <a href="tel:+17739200030" className="hover:text-amber-500 transition">
              +1-773-920-0030
            </a>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="rounded-xl border border-white/10 bg-white/5 p-6 hover:border-amber-500/50 transition">
              <Brain className="h-8 w-8 text-amber-500 mb-3" />
              <h3 className="font-semibold mb-2">Private LLM Deployments</h3>
              <p className="text-white/70 text-sm">Complete on-premise LLM infrastructure with custom fine-tuning</p>
            </div>
            <div className="rounded-xl border border-white/10 bg-white/5 p-6 hover:border-amber-500/50 transition">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {['AI Infrastructure', 'GPU Clusters', 'Private LLM Deployment', 'On-Premise Systems', 'Agent Orchestration', 'Confidential Computing'].map((skill) => (
              <div key={skill} className="px-4 py-2 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-500 text-sm text-center">
                {skill}
              </div>
            ))}
          </div>
        ...
        <div className="rounded-2xl border-2 border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-slate-900 p-8 mb-12">
          <h2 className="text-2xl font-bold mb-4 text-amber-500">Strategic Counsel Advisory Console</h2>
          ...
          <Link href="/darkgpt/request">
            <button className="w-full px-6 py-3 bg-amber-500 text-black font-semibold rounded-xl hover:bg-amber-500 transition">
